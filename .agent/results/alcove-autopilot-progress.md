...
- [ ] Slice 8 — Display Placement Persistence: production pure geometry/state migration and 73 placement tests complete; AppKit coordination and persistence migration remain.
