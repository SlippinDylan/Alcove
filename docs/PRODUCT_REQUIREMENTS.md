...
| AC-25 | File and folder context menus preserve or replace selection like Finder, expose only valid native actions, keep blank-space selection unchanged, and route multi-item Finder, AirDrop, path-copy, Terminal, Quick Look, open, and Trash actions in stable grid order | FR-27 |
