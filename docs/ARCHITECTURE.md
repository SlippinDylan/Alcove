...
- `FileGridDelegate` — handles selection, double-click, keyboard events, native pasteboard writers, background drops, and `.on` drops targeting ordinary directory items; Quick Look remains a responder-chain concern
