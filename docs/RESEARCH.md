...
| URL resource values supply the localized system kind and displayable size, while `FileManager` deep URL enumeration does not resolve or recurse through encountered symbolic links | **Confirmed by Apple** | [Apple Developer — localizedTypeDescriptionKey](https://developer.apple.com/documentation/foundation/urlresourcekey/localizedtypedescriptionkey); [Apple Developer — fileSize](https://developer.apple.com/documentation/foundation/urlresourcevalues/filesize); [Apple Developer — directory enumerator](https://developer.apple.com/documentation/foundation/filemanager/enumerator(at:includingpropertiesforkeys:options:errorhandler:)) |
