...
| INF-04 | Superseded by the 2026-09-12 product decision: Alcove uses one portal-level glass surface behind both controls and file content, while keeping individual file cells non-glass | Apple recommends glass for chrome/navigation/controls rather than content; this explicit product direction therefore requires manual readability and visual validation |
