...
<table>
  <tr>
    ...
    <td width="68%"><img src="images/readme/portal-overview.png" alt="显示两个标签页和原生图标网格的 Alcove 文件夹面板"></td>
  </tr>
  <tr>
    <td>
    ...
    <td><img src="images/readme/file-actions.png" alt="包含常用文件操作的 Alcove 右键菜单"></td>
  </tr>
  <tr>
    <td>
    ...
    <td><img src="images/readme/portal-creation.png" alt="带实时网格预览的 Alcove 面板创建界面"></td>
  </tr>
  <tr>
    <td>
    ...
    <td align="center"><img src="images/readme/folder-tabs.png" width="420" alt="显示两个文件夹标签页的 Alcove 面板设置"></td>
  </tr>
  <tr>
    <td>
    ...
    <td><img src="images/readme/panel-controls.png" alt="包含固定、排序、设置和删除操作的 Alcove 面板菜单"></td>
  </tr>
  <tr>
    <td>
    ...
    <td align="center"><img src="images/readme/appearance-settings.png" width="420" alt="包含透明度和面板样式选项的 Alcove 外观设置"></td>
  </tr>
  <tr>
    <td>
    ...
    <td align="center"><img src="images/readme/language-settings.png" width="420" alt="包含登录启动和应用语言选项的 Alcove 通用设置"></td>
  </tr>
</table>
...
| 文档 | 内容 |
|---|---|
| [当前交接](HANDOFF.md) | 当前需求、实现进度、已知风险和交接记录 |
| [产品需求](PRODUCT_REQUIREMENTS.md) | 产品目标、交互规则和验收标准 |
| [架构](ARCHITECTURE.md) | 模块边界、数据模型、持久化和并发设计 |
| [研究记录](RESEARCH.md) | API 资料、技术验证和参考项目 |
| [交付计划](DELIVERY_PLAN.md) | 开发阶段、测试矩阵和发布门槛 |
