...
Установите текущую бета-версию из публичного персонального tap:
...
- В приложении нет телеметрии и аналитики. Пользовательские данные остаются на Mac, а сеть используется только для получения подписанных обновлений.
