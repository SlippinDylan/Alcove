...
- **Liquid Glass on macOS 26** for the centered folder-tab control group, with an always-active translucent portal background; macOS 15–25 uses `NSVisualEffectView` for both roles
