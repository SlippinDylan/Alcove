...
> Slices 1–5 now provide the tested universal AppKit shell, single-folder portal,
> Finder-style interaction, transactional creation, and atomic local restoration;
