...
final class PortalCoordinator: PortalCoordinating, PanelPositionRepairing {
    ...
    private let layoutImporter: PortalLayoutImporter
    ...
    init(
        ...
        layoutImporter = PortalLayoutImporter(locationValidator: locationValidator)
    ...
    func replaceLayout(with backup: AlcoveLayoutBackup) async throws {
        try await performMutation { [weak self] in
            ...
            let importedPortals = try await layoutImporter.portals(
                from: backup,
