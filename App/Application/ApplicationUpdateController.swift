...
final class ApplicationUpdateController: NSObject, ApplicationUpdating, SPUUpdaterDelegate {
    ...
    static func allowedChannels(for updateChannel: String) -> Set<String> {
        ...
        default:
            preconditionFailure("Unsupported Alcove update channel: \(updateChannel)")
        }
    }
}
