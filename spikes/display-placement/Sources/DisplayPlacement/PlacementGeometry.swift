...
// Alcove Spike 0.2A — Pure display placement geometry model.
//
// UI-free: imports CoreGraphics and Foundation only.
// No AppKit, no real screen enumeration, no display UUID lookup.
// This is disposable spike code, not production AlcoveCore.
...
public struct PlacementRecord: Sendable, Equatable {
